// DỮ LIỆU ĐẠI DIỆN (PLACEHOLDERS) CHO CÁC TRẬN ĐẤU LOẠI TRỰC TIẾP TỪ FILE 32DOI.XLSX & SƠ ĐỒ NHÁNH ĐẤU GIẢI ĐẤU
    const KNOCKOUT_PLACEHOLDERS = {
      73: { home: "Nhất Bảng A", away: "Ba Bảng C/E/F" },
      74: { home: "Nhì Bảng A", away: "Nhì Bảng B" },
      75: { home: "Nhất Bảng E", away: "Ba Bảng A/B/C/D/F" },
      76: { home: "Nhất Bảng C", away: "Nhì Bảng F" },
      77: { home: "Nhất Bảng F", away: "Nhì Bảng C" },
      78: { home: "Nhì Bảng E", away: "Nhì Bảng I" },
      79: { home: "Nhất Bảng I", away: "Ba Bảng C/D/F/G/H" },
      80: { home: "Nhất Bảng A", away: "Ba Bảng C/E/F/H/I" },
      81: { home: "Nhất Bảng L", away: "Ba Bảng E/H/I/J/K" },
      82: { home: "Nhất Bảng G", away: "Ba Bảng A/E/H/I/J" },
      83: { home: "Nhất Bảng D", away: "Ba Bảng B/E/F/I/J" },
      84: { home: "Nhất Bảng H", away: "Nhì Bảng J" },
      85: { home: "Nhì Bảng K", away: "Nhì Bảng L" },
      86: { home: "Nhất Bảng B", away: "Ba Bảng E/F/G/I/J" },
      87: { home: "Nhất Bảng J", away: "Nhì Bảng H" },
      88: { home: "Nhì Bảng D", away: "Nhì Bảng G" },
      
      89: { home: "Thắng Trận 73", away: "Thắng Trận 74" },
      90: { home: "Thắng Trận 75", away: "Thắng Trận 76" },
      91: { home: "Thắng Trận 77", away: "Thắng Trận 78" },
      92: { home: "Thắng Trận 79", away: "Thắng Trận 80" },
      93: { home: "Thắng Trận 81", away: "Thắng Trận 82" },
      94: { home: "Thắng Trận 83", away: "Thắng Trận 84" },
      95: { home: "Thắng Trận 85", away: "Thắng Trận 86" },
      96: { home: "Thắng Trận 87", away: "Thắng Trận 88" },
      
      97: { home: "Thắng Trận 89", away: "Thắng Trận 90" },
      98: { home: "Thắng Trận 91", away: "Thắng Trận 92" },
      99: { home: "Thắng Trận 93", away: "Thắng Trận 94" },
    ...
    function normalizeGame(game) {
      ...
      const homeGoals = game.home_score !== null && game.home_score !== undefined && game.home_score !== 'null' ? parseInt(game.home_score) : null;
      const awayGoals = game.away_score !== null && game.away_score !== undefined && game.away_score !== 'null' ? parseInt(game.away_score) : null;
      ...
      const parseScorersStr = (scorersStr, scoringTeamCountryEn) => {
        ...
        return parts.map(part => {
          ...
          // Hỗ trợ cả ký hiệu tiếng Anh (OG) và tiếng Ba Tư (گل به خودی) cho bàn phản lưới
      ...
      let winner = null;
      if (status === 'completed') {
        if (homeGoals > awayGoals) winner = game.home_team_name_en;
        else if (awayGoals > homeGoals) winner = game.away_team_name_en;
        else winner = 'Draw';
      }
